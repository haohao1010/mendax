/*
Compiling this test code gave me an error,
but for the time being I haven't figured out what caused it to fail the test.
*/
...
describe("test Lexer", () => {
    ...
    it("test deleting a comment line", () => {
        const lexer = new Lexer()
